...
class AppLaunch(tank.Hook):
    ...
    def execute(self, app_path, app_args, version, engine_name, **kwargs):
        ...
        # env vars for Deadline
        # Set some utility global environment vars
        os.environ['MV_PROJECT'] = self.parent.tank.project_path
        os.environ['MV_PROJECT_PATH'] = self.parent.tank.project_path
        os.environ['MV_PROJECTCODE'] = os.path.split(self.parent.tank.project_path)[1]
