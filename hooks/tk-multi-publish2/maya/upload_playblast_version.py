...
class UploadVersionPlugin(HookBaseClass):
    ...
    def accept(self, settings, item):
        ...
        # working_template_path = tk.templates["maya_" + entity_type + "_playblast"]
        # publish_template_path = tk.templates["maya_" + entity_type + "_pub_playblast"]
    ...
    def validate(self, settings, item):
        ...
        # TODO: Need to check if the file has already been published
